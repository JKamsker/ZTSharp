...
if (auth.ExitCode != 0)
{
    Console.Error.WriteLine("net auth test failed:");
...
{
    Console.Error.WriteLine("net network create failed:");
...
{
    Console.Error.WriteLine("Could not parse nwid from net output:");
