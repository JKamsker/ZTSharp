...
public sealed class ZeroTierSocketPersistenceTests
{
    ...
    public async Task CreateAsync_LoadsPersistedManagedIps()
    {
        ...
        try
        {
            ...
            ZeroTierIdentityStore.Save(Path.Combine(statePath, "identity.bin"), identity);
    ...
    public async Task CreateAsync_ImportsLibztIdentity_WhenPresent()
    {
        ...
        try
        {
            ...
            Assert.True(ZeroTierIdentityStore.TryLoad(importedIdentityPath, out var persisted));
