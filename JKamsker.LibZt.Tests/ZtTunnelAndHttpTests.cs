...
public sealed class ZtTunnelAndHttpTests
{
    [Fact]
    public async Task InMemoryOverlayPortForwarder_ForwardsBytes()
    {
        ...
        try
        {
            ...
            await using var overlayClient = new ZtOverlayTcpClient(clientNode, networkId, localPort: 25001);
    ...
    public async Task InMemoryOverlayHttpHandler_CanFetchThroughForwarder()
    {
        ...
        try
        {
            ...
            using var httpClient = new HttpClient(new ZtOverlayHttpMessageHandler(clientNode, networkId));
    ...
    private static ZtNode CreateInMemoryNode()
    {
        return new ZtNode(new ZtNodeOptions
        {
