...
public sealed class ZtZeroTierDictionaryTests
{
    [Fact]
    public void TryGet_ReturnsPlainStringBytes()
    {
        var dict = Encoding.ASCII.GetBytes("k=abc\r\n");
        Assert.True(ZtZeroTierDictionary.TryGet(dict, "k", out var value));
    ...
    public void TryGet_UnescapesBinaryNull()
    {
        ...
        Assert.True(ZtZeroTierDictionary.TryGet(dict, "I", out var value));
