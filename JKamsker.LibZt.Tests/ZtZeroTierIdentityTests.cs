...
public sealed class ZtZeroTierIdentityTests
{
    ...
    public void KnownGoodIdentity_LocallyValidates()
    {
        ...
        Assert.Equal(new ZtNodeId(0x8e4df28b72), identity.NodeId);
    ...
    {
        Assert.True(ZtZeroTierIdentity.TryParse(KnownBadIdentity, out var identity));
        Assert.Equal(new ZtNodeId(0x9e4df28b72), identity.NodeId);
