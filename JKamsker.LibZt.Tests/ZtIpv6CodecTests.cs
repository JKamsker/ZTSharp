...
public sealed class ZtIpv6CodecTests
{
    [Fact]
    public void Encode_Parse_RoundTrips()
    {
        ...
        Assert.True(ZtIpv6Codec.TryParse(packet, out var parsedSrc, out var parsedDst, out var nextHeader, out var hopLimit, out var parsedPayload));
