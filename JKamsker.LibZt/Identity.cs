...
internal static class IdentitySerializer
{
    private const int SecretLength = 32;
    private const int PublicLength = 32;

    public static ReadOnlyMemory<byte> Serialize(Identity identity)
    {
    ...
    public static Identity? TryDeserialize(ReadOnlyMemory<byte> data)
    {
