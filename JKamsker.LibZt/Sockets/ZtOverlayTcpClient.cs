...
/// </summary>
public sealed class ZtOverlayTcpClient : IAsyncDisposable
{
    ...
    private ZtOverlayTcpStream? _stream;

    public ZtOverlayTcpClient(ZtNode node, ulong networkId, int localPort)
    {
    ...
    public Stream GetStream()
    {
        ...
        var created = new ZtOverlayTcpStream(this);
        _stream = created;
        return created;
    }
    ...
    private sealed class ZtOverlayTcpStream : Stream
    {
        private readonly ZtOverlayTcpClient _client;

        public ZtOverlayTcpStream(ZtOverlayTcpClient client)
        {
            _client = client;
        }
