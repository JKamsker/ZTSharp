...
internal sealed class ZtZeroTierWorld
{
    public const int C25519PublicKeyLength = 64;
    public const int C25519SignatureLength = 96;

    public ZtZeroTierWorld(
        ZtZeroTierWorldType type,
        ulong id,
        ulong timestamp,
        byte[] updatesMustBeSignedBy,
        byte[] signature,
        IReadOnlyList<ZtZeroTierWorldRoot> roots)
    {
    ...
    public ZtZeroTierWorldType Type { get; }
    ...
    public IReadOnlyList<ZtZeroTierWorldRoot> Roots { get; }
}
