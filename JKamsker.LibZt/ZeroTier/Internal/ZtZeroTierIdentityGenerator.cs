...
internal static class ZtZeroTierIdentityGenerator
{
    public static ZtZeroTierIdentity Generate(CancellationToken cancellationToken = default)
    {
        ...
        while (true)
        {
            ...
            while (true)
            {
                ...
                return new ZtZeroTierIdentity(new ZtNodeId(address), (byte[])publicKey.Clone(), (byte[])privateKey.Clone());
            }
        }
    }
