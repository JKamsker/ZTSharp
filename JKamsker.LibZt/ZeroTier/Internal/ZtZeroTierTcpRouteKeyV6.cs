...
internal readonly record struct ZtZeroTierTcpRouteKeyV6(
    ulong LocalIpHigh,
    ulong LocalIpLow,
    ushort LocalPort,
    ulong RemoteIpHigh,
    ...
    ushort RemotePort)
{
    public static ZtZeroTierTcpRouteKeyV6 FromEndpoints(IPEndPoint local, IPEndPoint remote)
    {
    ...
    public static ZtZeroTierTcpRouteKeyV6 FromAddresses(IPAddress localAddress, ushort localPort, IPAddress remoteAddress, ushort remotePort)
    {
        ...
        return new ZtZeroTierTcpRouteKeyV6(
