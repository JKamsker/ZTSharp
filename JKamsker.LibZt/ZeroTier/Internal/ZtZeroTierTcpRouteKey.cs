...
internal readonly record struct ZtZeroTierTcpRouteKey(
    uint LocalIp,
    ushort LocalPort,
    uint RemoteIp,
    ushort RemotePort)
{
    public static ZtZeroTierTcpRouteKey FromEndpoints(IPEndPoint local, IPEndPoint remote)
    {
        ...
        return new ZtZeroTierTcpRouteKey(
