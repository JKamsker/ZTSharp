...
public sealed class ZtZeroTierHttpMessageHandler : DelegatingHandler
{
    private readonly ZeroTier.ZtZeroTierSocket _socket;

    public ZtZeroTierHttpMessageHandler(ZeroTier.ZtZeroTierSocket socket)
    {
